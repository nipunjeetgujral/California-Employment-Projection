...
Revenue_Display(Revenue, "Riverside") 
```
...
Industry_Display <- function(data, county) {
  ...
  if(county == "None"){ 
    ...
    plot <- Top_Industry %>% 
      ...
      plotly::layout(xaxis = list(title = "People Employed", gridcolor = "#4b4949"),
                     yaxis = list(title = "", gridcolor = "#4b4949"),
...
Industry_Display(Industry, "San Francisco")
```
  ...
  if(county == "None"){ 
    ...
    plot <- plotly::plot_ly() %>% 
      ...
      plotly::animation_opts(1000, 
                             easing = "elastic", 
                             redraw = FALSE) %>% 
      plotly::layout(xaxis = list(title = "Year", gridcolor = "#4b4949"),
                     yaxis = list(title = "Population", gridcolor = "#4b4949"),
  ...
  if(county == "None"){ 
    ...
    plot <- data %>%
      ...
      plotly::plot_ly(x = ~Year, y = ~Average_Unemployment_Rate,
                      type = "scatter", mode = "lines+markers",
                      error_y = ~list(array = SD_Unemployment_Rate, color = '#c3c3c3'),
                      marker = list(size = 7),
                      text = ~paste("Year: ", Year, "\n",
                                    "Average Unemployment Rate: ", Average_Unemployment_Rate, "%", 
                                     sep = "")) %>% 
      plotly::layout(xaxis = list(title = "Year", gridcolor = "#4b4949"),
                     yaxis = list(title = "Unemploymnet Rate", gridcolor = "#4b4949"),
